...
class MultiSiteTest extends TestCase
{
    ...
    public function testJobDistributionStrategies()
    {
        ...
        array(
        'id'           => 1,
        'capabilities' => array( 'processing_power' => 'high' ),
        'stats'        => array( 'current_load' => 20 ),
        ),
        array(
        'id'           => 2,
        'capabilities' => array( 'processing_power' => 'medium' ),
        'stats'        => array( 'current_load' => 50 ),
        ),
        array(
        'id'           => 3,
        'capabilities' => array( 'processing_power' => 'low' ),
        'stats'        => array( 'current_load' => 80 ),
        ),
        );
    ...
    public function testCapabilityScoreCalculation()
    {
        ...
        $site = array(
        'capabilities' => array(
        'supported_formats' => array( 'json', 'xml' ),
    ...
    public function testNetworkTableCreation()
    {
        ...
        $expected_columns = array( 'id', 'job_id', 'site_id', 'status', 'priority', 'data', 'created_at', 'updated_at' );
