...
class ApiIntegrationTest extends TestCase
{
    ...
    public function testRestApiEndpointRegistration()
    {
        ...
        $methods = [
            'POST' => ['import', 'cancel'],
            'GET' => ['status', 'feeds', 'analytics', 'health', 'performance', 'jobs'],
            'PUT' => ['feeds'],
            'DELETE' => ['feeds']
        ];
    ...
    public function testStatusApiEndpoint()
    {
        ...
        // Test status values
        $validStatuses = ['idle', 'running', 'completed', 'failed', 'cancelled'];
    ...
    public function testHealthApiEndpoint()
    {
        ...
        // Test check results
        $validCheckResults = ['ok', 'warning', 'error'];
    ...
    public function testJobsApiEndpoint()
    {
        ...
        $requiredFields = ['id', 'title', 'company', 'location'];
        ...
        $bulkResponse = [
            ...
            'data' => [
                ...
                'results' => [
                    ['id' => 1, 'status' => 'success'],
                    ['id' => 2, 'status' => 'success'],
                    ['id' => 3, 'status' => 'failed', 'error' => 'Invalid URL'],
                    ['id' => 4, 'status' => 'success'],
                    ['id' => 5, 'status' => 'success']
                ]
            ]
