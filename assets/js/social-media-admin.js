...
(function($) {
    ...
    function initializeSocialMediaAdmin() {
        ...
        $('.test-platform').on('click', function() {
            ...
            $button.prop('disabled', true).text(puntwork_social_ajax.strings.testing);
            $status.hide();
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'puntwork_social_test_platform',
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        showStatus($status, response.data.message || puntwork_social_ajax.strings.test_failed, 'error');
                    }
                },
                error: function() {
