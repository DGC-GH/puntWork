...
function enqueue_job_import_scripts() {
    ...
    if ($should_load) {
        ...
        wp_enqueue_script(
            'puntwork-logger-js',
            PUNTWORK_URL . 'assets/puntwork-logger.js',
            ['jquery'],
            PUNTWORK_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'job-import-ui-js',
            PUNTWORK_URL . 'assets/job-import-ui.js',
        ...
        wp_enqueue_script(
            'job-import-api-js',
            PUNTWORK_URL . 'assets/job-import-api.js',
            ['jquery', 'puntwork-logger-js'],
            PUNTWORK_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'job-import-logic-js',
            PUNTWORK_URL . 'assets/job-import-logic.js',
        ...
        wp_enqueue_script(
            ...
            PUNTWORK_URL . 'assets/job-import-events.js',
        ...
        wp_enqueue_script(
            ...
            PUNTWORK_URL . 'assets/job-import-scheduling.js',
        ...
        wp_enqueue_script(
            'job-import-admin-js',
            PUNTWORK_URL . 'assets/job-import-admin.js',
