...
class PuntworkCrmAdmin
{
    ...
    public function enqueueScripts(string $hook): void
    {
        ...
        wp_enqueue_style('puntwork-crm-admin', plugin_dir_url(__FILE__) . '../../assets/css/crm-admin.css', [], '1.0.0');
        wp_enqueue_script('puntwork-crm-admin', plugin_dir_url(__FILE__) . '../../assets/js/crm-admin.js', ['jquery'], '1.0.0', true);
    ...
    public function ajaxTestConnection(): void
    {
        ...
        if (empty($platform_id)) {
            wp_send_json_error(['message' => __('Platform ID is required', 'puntwork')]);
        }
    ...
    public function ajaxSyncTest(): void
    {
        ...
        $result = $this->crm_manager->syncJobApplication($test_application, [$platform_id]);
