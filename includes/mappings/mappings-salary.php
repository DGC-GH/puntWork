    ...
    function GetSalaryEstimates()
    {
        ...
        if (false === $cached) {
            $cached = [
                ...
                'Contrôle Qualité, Prévention & Environnement' => [
                    'low' => 3300,
                    'high' => 4800,
                ],
                'Q&A, Milieu & Preventie' => [
                    'low' => 3300,
                    'high' => 4800,
                ],
                'Customer Care' => [
                ...
                'Gezondheidszorg, Sociale & Medische Diensten' => [
                    'low' => 3200,
                    'high' => 4700,
                ],
                'Santé, Service Social & Médical' => [
                    'low' => 3200,
                    'high' => 4700,
                ],
                'Grafisch & Architectuur' => [
                    'low' => 3000,
                    'high' => 4500,
                ],
                ...
                'Horeca, Évènements & Tourisme' => [
                    'low' => 2500,
                    'high' => 3800,
                ],
                'Horeca, Events & Toerisme' => [
                    'low' => 2500,
                    'high' => 3800,
                ],
                'Human Resources' => [
                ...
                'R&D, Wetenschap & Wetenschappelijk Onderzoek' => [
                    'low' => 3800,
                    'high' => 5500,
                ],
                'Sales & Marketing' => [
                ...
                'Transport, Logistics & Purchase' => [
                    'low' => 3000,
                    'high' => 4500,
                ],
                'Transport, Logistiek & Aankoop' => [
                    'low' => 3000,
                    'high' => 4500,
                ],
