<?php
/**
 * Mappings and Constants for Job Import Plugin
 * Ported from old WPCode snippet 1.1 - Mappings and Constants.php
 */
...
define( 'JOB_IMPORT_CACHE_TTL', HOUR_IN_SECONDS * 6 ); // 6 hours for gzip cache

/**
 * Province mapping for normalization (e.g., Dutch/French to 'be').
 */
...
/**
 * Salary estimates by function group.
 */
...
/**
 * Icon mapping by function group.
 */
